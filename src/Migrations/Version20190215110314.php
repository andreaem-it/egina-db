 ...
 */
final class Version20190215110314 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__guests AS SELECT id, name_id_id, type, location FROM guests');
        ...
        $this->addSql('INSERT INTO guests (id, name_id, type, location) SELECT id, name_id_id, type, location FROM __temp__guests');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP TABLE guests');
        $this->addSql('CREATE TABLE guests (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, type INTEGER NOT NULL, location VARCHAR(255) NOT NULL, name_id_id INTEGER DEFAULT NULL)');
        $this->addSql('INSERT INTO guests (id, name_id_id, type, location) SELECT id, name_id, type, location FROM __temp__guests');
        $this->addSql('DROP TABLE __temp__guests');
