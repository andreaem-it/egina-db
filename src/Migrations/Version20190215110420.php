 ...
 */
final class Version20190215110420 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE guests (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, type INTEGER NOT NULL, location VARCHAR(255) NOT NULL COLLATE BINARY, name VARCHAR(255) NOT NULL)');
